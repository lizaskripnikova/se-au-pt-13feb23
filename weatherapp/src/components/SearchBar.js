...
class SearchBar extends Component {
  constructor(props) {
    ...
    // Binding the event handler functions to the component 
    this.handleChange = this.handleChange.bind(this);
    this.sendValueToParent = this.sendValueToParent.bind(this);
  }

  // A function to update the state with the input field value
  handleChange(event) {
    this.setState({ value: event.target.value });
  }

  // A function to pass the input value back to the parent component
  ...
  render() {
    ...
    return (
      <div className="SearchBar">
        ...
        {/* Display warning message if the input is invalid */}
        {this.state.warning && warningMessage}
        {/* Form containing the input field for city search */}
